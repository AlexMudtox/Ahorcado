// Declaro un Array con las palabras que se usaran en el juego
const palabras = [
  "ganador",
  "insulto",
  "irrigar",
...
//Selecciono una palabra aleatoria del array "words"
let palabraSeleccionada = palabras[Math.floor(Math.random() * palabras.length)]; //Selectedword
//Inicializa el número de intentos que el usuario tiene (6 intentos)
let maxWrong = 6; //attempsLeft
// Inicializa un array para almacenar las letras que el usuario ha adivinado.
let letrasAdivinadas = []; //guessedletters
//Inicializa un array para almacenar las letras correctas adivinadas por el usuario.
let letrasCorrectas = []; //correctletters

//Obtiene la referencia al contenedor donde se mostrará la palabra.
const wordContainer = document.getElementById("word-container");
//Obtiene la referencia al contenedor donde se mostrarán las letras del alfabeto.
const lettersContainer = document.getElementById("letters-container");
//Obtiene la referencia al elemento donde se mostrará el mensaje de victoria o derrota.
const messageElement = document.getElementById("message");
//Obtiene la referencia al botón de reinicio.
